...
function _attachment_palette($id)
{
...
function _get_all_attachments()
{
    ...
    foreach ($query_images->posts as $image) {
        ...
        $tone = (_attachment_hex_average($colors) > (255 / 2)) ? true : false;
...
function _attachment_hex_average($array)
{
    $tone = 0;
...
function _attachment_hex_array($src)
{
...
add_filter('attachment_fields_to_edit', function ($form_fields, $post) {
    ...
    $colors = _attachment_palette($post->ID);
